...
import com.example.jpa.repository.FoodRepository;
import com.example.jpa.repository.MemberRepository;
import com.example.jpa.repository.OrdersRepository;
...
@Component
    ...
    public class Restaurant implements ApplicationRunner {
        ...
        public void run(ApplicationArguments args) throws Exception {
            ...
            foods.add(food5);
            foodRepository.saveAll(foods);  //리스트 안에있는 모든 것을 저장한다.
            ...
            List<Food> findFoods = foodRepository.findAll();   //findAll을 사용해서 음식 리스트를 모두 가져온다.
            ...
            ordersRepository.saveAll(ordersList);  //saveAll을 사용해서 데이터베이스에 insert한다.
